...
This table lists the configuration variables required to operate MalShare. These variables are specified when configuring a MalShare asset in Splunk SOAR.
...
--------- | ---- | -------- | --------------
action_result.status | string | | success failed |
action_result.message | string | | Vault id: 51fbcaba1f6832dae1d3b8060a874e71c52e93c8 Name: ec091d840d8e6e179804cf5a2ea81e58 File found: True |
